...
- 🔴 **3D Visual Reconstruction (Gaussian Splatting, VGGT)** 🔴 ➡️ for building efficient and accurate scene representations.
- 🔵 **AI-based Localization and Perception** 🔵 ➡️including visual place recognition, multi-sensor fusion, map-based reasoning.
- 🟢 **Vision-Language Navigation and Action** 🟢 ➡️connecting natural language with spatial behaviors.
</details>
